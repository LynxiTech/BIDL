...
# @hydra.main(config_path='config', config_name='val823', version_base='1.2')
def main(config: DictConfig):
    ...
    params = torch.load(ckpt_path, map_location=torch.device('cpu'))
    module.load_state_dict(params['state_dict'])
...
if __name__ == '__main__':
    ...
    cfg = compose(config_name="val_gpu")
    main(cfg)
