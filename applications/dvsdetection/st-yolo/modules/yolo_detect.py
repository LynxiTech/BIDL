...
class Module(pl.LightningModule):
    def __init__(self, full_config: DictConfig):
        ...
        self.mdl = YoloV5Detector(self.mdl_config)
    ...
    def _val_test_step_impl(self, batch: Any, mode: Mode) -> Optional[STEP_OUTPUT]:
        ...
        for tidx in range(sequence_len):
            ...
            # backbone_features = self.mdl.forward_backbone(x=ev_tensors, previous_states=prev_states)
            # states = backbone_features
            prev_states = states
    ...
    def run_psee_evaluator(self, mode: Mode):
        ...
        if psee_evaluator.has_data():
            ...
            print(f'平均帧率为{11 * self.val_test_step_counter / self.t_total}fps')
