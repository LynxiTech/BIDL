# Acknowledgments
# This code is built upon the implementation of the RVT project, with substantial modifications.
# RVT: [https://github.com/uzh-rpg/RVT](https://github.com/uzh-rpg/RVT)
